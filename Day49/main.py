""" This script can be used to apply for jobs on Linkedin. The account cannot have 2FA enabled.
"""
...
ACCOUNT_EMAIL = os.environ["LINKEDIN_UN"]
ACCOUNT_PASSWORD = os.environ["LINKEDIN_PW"]
...
chrome_driver_path = ChromeDriverManager(
    path="/Users/jmb2393/Development/chromedriver"
).install()
